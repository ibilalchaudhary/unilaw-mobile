...
export default function BookCardDetails({navigation}) {
  return (
    <ImageBackground
      ...
      <ScrollView style={{paddingHorizontal: 20, flex: 1}}>
        ...
        <View
          ...
          <View
            ...
            <Text style={{fontSize: 18, color: '#272727'}}>English,Urdu</Text>
            <Text style={{fontSize: 14, color: '#272727'}}>Language</Text>
          </View>
          <View
            style={{
              width: '33%',
